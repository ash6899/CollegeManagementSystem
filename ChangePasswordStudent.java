...
public class ChangePasswordStudent extends JFrame implements ActionListener
{
	...
	public ChangePasswordStudent(String a)
	{
		setSize(700,500);
		setTitle("Change Password Student");
										...
										try
												{
													...
													String query="select* from studentdetail where ID='"+collegeid+"' AND PASSWORD='"+old+"'";
														...
														try
															{
																...
																String query1="update studentdetail Set PASSWORD='"+recent+"' where PASSWORD='"+old+"'";
