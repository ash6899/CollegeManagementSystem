...
public class ChangePasswordFaculty extends JFrame implements ActionListener
{
	...
	{
		setSize(700,500);
		setTitle("Change Password Faculty");
										...
										try
												{
													...
													String query="select* from facultydetail where PASSWORD='"+old+"'";
														...
														try
															{
																...
																String query1="update facultydetail Set PASSWORD='"+recent+"' where PASSWORD='"+old+"'";
