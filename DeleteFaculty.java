...
public class DeleteFaculty extends JFrame implements ActionListener
{
	...
	public DeleteFaculty()
	{
		...
		delete.setBounds(400,400,100,20);
		add(fid);
		add(fname);
		add(dept);
		add(datejoin);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource() == delete)
		{
					try
				{
					...
					Statement stmt=con.createStatement();
					String facultyid=id.getText().trim();
					String query="delete from facultydetail where ID='"+facultyid+"'";
					long ans=stmt.executeUpdate(query);
					if(ans==0)
						JOptionPane.showMessageDialog(this,"The Record is not Deleted.");
					else{
						JOptionPane.showMessageDialog(this,"The Record is Successfully Deleted.");
						id.setText("");
						name.setText("");
						department.setText("");
						dateofjoin.setText("");
